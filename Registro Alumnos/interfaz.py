...
class InterfazApp(Tk):
    ...
    def construir_widget(self):
        ...
        self.label_cantidad=Label(self.cajas_textos,text="Apellido",bg=COLOR_FONDO_PRIMARIO,fg="white",font=("Roboto",10)).pack(pady=10)
        ...
        self.label_precio=Label(self.cajas_textos,text="DNI",bg=COLOR_FONDO_PRIMARIO,fg="white",font=("Roboto",10)).pack(pady=10)
        ...
        #TABLA DE DATOS
        self.caja_datos=LabelFrame(self,text="Datos del Alumno",width=600,height=360,bg=COLOR_FONDO_PRIMARIO,fg="white",font=("arial",12),relief=FLAT,pady=60)
